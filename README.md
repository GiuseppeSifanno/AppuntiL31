...
- **Better Export PDF**: Permette di poter estrarre i markdown in PDF (al momento non funzionante su Linux, per questo c'è un ritardo fondamentale con la pubblicazione dei miei PDF)
