...
Dalla definizione data, l’automa M, esaminando la stringa $w$ compie una serie di mosse (o transizioni) che lo portano dallo stato [da inserire latex]; pertanto [da inserire latex].
