...
**Card 18:** Come si definisce il linguaggio L(G) generato da una grammatica G? **Risposta:** È l'insieme di stringhe terminali derivabili dal simbolo di partenza $S$: $$L(G)={w \in X^{_} | S \Rightarrow^_ w}$$
