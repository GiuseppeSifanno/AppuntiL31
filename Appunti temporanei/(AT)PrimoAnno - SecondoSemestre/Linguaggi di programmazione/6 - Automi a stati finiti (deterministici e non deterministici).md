...
Sia M = $(Q, \delta, q_{0}, F)$ un FSA con alfabeto di ingresso $X$. Una parola $w \in X^*$ è accettata (o riconosciuta) da $M$ se, partendo dallo stato iniziale $q_{0}, lo stato q in cui
l’automa si porta alla fine della sequenza di ingresso
w è uno stato finale.
