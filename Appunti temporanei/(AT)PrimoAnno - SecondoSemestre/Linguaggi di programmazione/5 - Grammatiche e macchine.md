...
Sia $w$ una parola su un alfabeto $X=\{x_{1},x_{2}\dots,x_{k}\}$, con $w=x_{i_{1}},x_{i_{2}} \dots x_{i_{n-1}},x_{i_{n}}$, si dice **stringa riflessa** o **riflessione** di $w$ la stringa 
